...
import { Mail, ArrowLeft, ShieldCheck, Lock, User, Loader2 } from "lucide-react";
import { toast } from "sonner";

const Register = () => {
    const { signUp, signInWithGoogle, userRole } = useAuth();
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 bg-gradient-to-b from-[#002B49]/5 to-background relative overflow-hidden selection:bg-primary/20">
            {/* Background Ornaments - Matching Login */}
                    ...
                    <div className="p-6 sm:p-10 lg:p-12">
                        ...
                        <div className="space-y-4 mt-8">
                            ...
                            <Button
                                ...
                                className="w-full h-12 sm:h-14 rounded-xl border-2 border-[#002B49]/10 hover:border-[#D4AF37] hover:bg-[#D4AF37]/5 transition-all duration-300 text-sm sm:text-base font-bold flex items-center justify-center gap-3"
                            >
                                {isGoogleLoading ? (
